...
// effects 'scale'. lower value = bigger effect
...
void matrixRoutine() {
  ...
  for (byte x = 0; x < WIDTH; x++) {
    ...
    if (thisColor == 0)
      drawPixelXY(x, HEIGHT - 1, 0xFF0000 * (random(0, 16) == 0));
    else if (thisColor < 0x200000)
      drawPixelXY(x, HEIGHT - 1, 0);
    else
      drawPixelXY(x, HEIGHT - 1, thisColor - 0x200000);
  }
